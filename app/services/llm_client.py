...
Правила разделения:
1. Если дефекты пронумерованы (1, 2, 3... или 1., 2., 3...) - разделяй по номерам
2. Если дефекты разделены точкой с запятой (;) - разделяй по точке с запятой
3. Если дефекты в отдельных предложениях - разделяй по предложениям
4. Каждый дефект должен быть отдельным элементом в списке
5. Убирай номера из начала дефекта (например "1Царапины" → "Царапины")
6. Если комментарий пустой или содержит "нет замечаний" - верни пустой список
7. Сохраняй текст дефекта без изменений (кроме удаления номеров)

Примеры:
Вход: "1Царапины на окне 2Трещина в раме 3Загрязнения"
Выход: [{"text": "Царапины на окне"}, {"text": "Трещина в раме"}, {"text": "Загрязнения"}]

Вход: "Царапины на окне; Трещина в раме"
Выход: [{"text": "Царапины на окне"}, {"text": "Трещина в раме"}]

...
КРИТИЧЕСКИ ВАЖНО:
- Выбирай категорию ТОЛЬКО из предложенного списка вариантов
- Копируй название категории ТОЧНО как оно написано в списке
- Если НИ ОДНА категория из списка не подходит к дефекту - пиши "НЕ ОПРЕДЕЛЕНО"
- Лучше написать "НЕ ОПРЕДЕЛЕНО" чем выбрать неподходящую категорию

ПРАВИЛА ВЫБОРА:
1. Анализируй СУТЬ дефекта - о каком элементе или работе идёт речь
2. Выбирай категорию только если ты УВЕРЕН что она подходит
3. Если сомневаешься между несколькими категориями - выбери наиболее специфичную
4. Если дефект не относится ни к одной категории - пиши "НЕ ОПРЕДЕЛЕНО"

Формат ответа (строго JSON):
{
  "results": [
    {"chosen": "ТОЧНОЕ название категории из списка ИЛИ НЕ ОПРЕДЕЛЕНО"},
    {"chosen": "ТОЧНОЕ название категории из списка ИЛИ НЕ ОПРЕДЕЛЕНО"}
  ]
}

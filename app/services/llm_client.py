...
Пример 1 - Пронумерованные дефекты БЕЗ пробелов:
Вход: "Окно 2 1Царапины и вмятины на внешних оконных откосах 2Отслоение уплотнительной резинки 3Зазоры в углах"
Выход: {"defects": [
...
Пример 3 - Длинные описания с номерами:
Вход: "1Царапины и вмятины на внешних оконных откосах и отлве 2Отслоение уплотнительной резинки 1го контура за правой створкой 3Зазоры и уступы в углах стыковки оконных штапиков всех створок оконного блока"
Выход: {"defects": [
  {"text": "Царапины и вмятины на внешних оконных откосах и отлве"},
  {"text": "Отслоение уплотнительной резинки 1го контура за правой створкой"},
  {"text": "Зазоры и уступы в углах стыковки оконных штапиков всех створок оконного блока"}
]}
...
ВАЖНО: Цифра в начале (1, 2, 3...) ВСЕГДА означает новый дефект! Разделяй по ним!

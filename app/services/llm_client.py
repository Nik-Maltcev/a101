...
Формат ответа (строго JSON):
{
  "results": [
    ...
    {"chosen": "ТОЧНОЕ название категории из списка"}
        ...
        user_prompt = f"""Классифицируй следующие дефекты. Для КАЖДОГО дефекта выбери ОДНУ категорию СТРОГО из предложенных вариантов.

{items_text}

ВАЖНО: Выбирай ТОЛЬКО из предложенных вариантов! Не придумывай свои категории!
Верни JSON с {len(defects_with_candidates)} результатами."""

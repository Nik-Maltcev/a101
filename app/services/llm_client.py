...
4. ЛОКАЦИИ - НЕ ЯВЛЯЮТСЯ ДЕФЕКТАМИ! Игнорируй:
   - "Окно", "Окно 1", "Окно 2", "Окна"
   - "Стена", "Стены"
   - "Пол", "Потолок"
   - "Дверь", "Двери"
   - "Балкон", "Лоджия"
   - "Санузел", "Ванная", "Кухня", "Комната", "Коридор", "Прихожая"
   - "Витраж", "Фасад", "Кровля"
   - Любые заголовки типа "Окно 1 (слева на право)"
